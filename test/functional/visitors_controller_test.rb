...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { email: @visitor.email, heard_from: @visitor.heard_from, message: @visitor.message, name: @visitor.name, postcode: @visitor.postcode, telephone: @visitor.telephone }
    end
  ...
  test "should update visitor" do
    put :update, id: @visitor, visitor: { email: @visitor.email, heard_from: @visitor.heard_from, message: @visitor.message, name: @visitor.name, postcode: @visitor.postcode, telephone: @visitor.telephone }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
